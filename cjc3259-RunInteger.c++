...
int main () {
    ...
    cout << "Time in sec = " << (double)final/1000000 << endl << endl;
    }
    ...
    cout << "TEST: could only get deque to work for the 431 power" << endl;
    {
    const Integer< int, std::deque<int> > n = Integer< int, std::deque<int> >(2).pow(431) - 1;

    cout << "2^431 - 1 = " << n << endl << endl;
    }
