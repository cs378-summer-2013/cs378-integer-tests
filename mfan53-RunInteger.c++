...
int main () {
    ...
    std::cout<<"RunInteger 20th Mersenne Prime DURATION: "<< duration <<std::endl;
    ...
    duration = ( std::clock() - start ) / (double) CLOCKS_PER_SEC;
    std::cout<<"RunInteger 20th Mersenne Prime (deque) DURATION: "<< duration <<std::endl;
    cout << "2^4423 - 1 = " << n << endl << endl;
    }
    ...
    duration = ( std::clock() - start ) / (double) CLOCKS_PER_SEC;
    std::cout<<"RunInteger 30th Mersenne Prime DURATION: "<< duration <<std::endl;
