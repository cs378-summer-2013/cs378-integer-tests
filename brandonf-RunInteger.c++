...
int main () {
    ...
    {
    const Integer<int> n = Integer<int>(2).pow(31) - 1;
    cout << "2^31 - 1 = " << n << endl << endl;
    }

    {
    const Integer< int, std::deque<int> > n = Integer< int, std::deque<int> >(2).pow(31) - 1;
    cout << "2^31 - 1 = " << n << endl << endl;
    }
    ...
    {
    const Integer< int, std::deque<int> > n = Integer< int, std::deque<int> >(2).pow(89) - 1;
    cout << "2^89 - 1 = " << n << endl << endl;
    }
